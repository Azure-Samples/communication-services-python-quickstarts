...
class NgrokService:
        ...
        for proc in psutil.process_iter():
            try:
                ...
                if process_name.lower() in proc.name().lower():
                    raise("Looks like NGROK is still running. Please kill it before running the provider again.")
    ...
    def create_ngrok_process(self, ngrokPath, authToken):
        ...
        self.__ngrokProcess = subprocess.Popen([executable, "http", "http://localhost:9007/", "-host-header", "localhost:9007"])
        ...
        try:
            ...
            while(totalAttempts > 0):
                ...
                if (tunnels and len(tunnels)):
                    ngrok_url = tunnels['tunnels'][0]['public_url']  # Do the parsing of the get
                    return ngrok_url
