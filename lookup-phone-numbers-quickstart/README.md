...
4.  Update lines 16 and 23 with the phone number you want to look up.
...
From a console prompt, navigate to the directory containing the number-lookup-sample.py file, then execute the following command to run the app.

python ./number-lookup-sample.py
