...
# ========================================
# Python Azure App Deployment Script
# ========================================
...
# Create zip using 7-Zip, excluding Python-specific files and directories
echo "📦 Creating deployment zip file for Python application..."
echo "   Excluding: .git/, .env, *.log, __pycache__/, venv/, *.pyc"
7z a -tzip "$ZIP_FILE" ./\* \
  -xr'!.git' \
  -xr'!*.env' \
  -xr'!*.log' \
...
echo "🚀 Deploying Python application to Azure Web App..."
